...
class UserAddressModel extends BaseModel{
	public $fields=array(
		...
		'useraddr_country'=>'国家',
		'useraddr_province'=>'省份',
		'useraddr_city'=>'城市',
		'useraddr_district'=>'地区',
    ...
    function __construct($inputPdoHelper = NULL){
        ...
        $this->_validateRuleArray = array(
			...
			'useraddr_country'=>array('rule'=>'/^-{0,0}[0-9]{1,11}$/','tip'=>'国家的值必须是整数且必须是正数,最大长度11'),
			'useraddr_province'=>array('rule'=>'/^-{0,0}[0-9]{1,11}$/','tip'=>'省份的值必须是整数且必须是正数,最大长度11'),
			'useraddr_city'=>array('rule'=>'/^-{0,0}[0-9]{1,11}$/','tip'=>'城市的值必须是整数且必须是正数,最大长度11'),
			'useraddr_district'=>array('rule'=>'/^-{0,0}[0-9]{1,11}$/','tip'=>'地区的值必须是整数且必须是正数,最大长度11'),
			'useraddr_address'=>array('rule'=>'/^(.*){1,1}$/','tip'=>'详细地址的值必须是字符且,最大长度100'),
			'useraddr_zipcode'=>array('rule'=>'/^(.*){1,1}$/','tip'=>'邮编的值必须是字符且,最大长度60'),
			...
			'useraddr_is_default'=>array('rule'=>'/^-{0,1}[0-9]{1,1}$/','tip'=>'是否默认地址的值必须是整数且,最大长度1'),
        ...
        $this->_testData = array(
			...
			'useraddr_is_default'=>0,
			'is_del'=>1
		);

    }
	public function insertTest(){
		$sql = "INSERT INTO user_address (id,user_id,useraddr_name,useraddr_email,useraddr_country,useraddr_province,useraddr_city,useraddr_district,useraddr_address,useraddr_zipcode,useraddr_tel,useraddr_mobile,useraddr_sign_building,useraddr_best_date,useraddr_is_default,is_del) VALUES (NULL,:user_id,:useraddr_name,:useraddr_email,:useraddr_country,:useraddr_province,:useraddr_city,:useraddr_district,:useraddr_address,:useraddr_zipcode,:useraddr_tel,:useraddr_mobile,:useraddr_sign_building,:useraddr_best_date,:useraddr_is_default,:is_del)";
