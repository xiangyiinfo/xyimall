<?php
namespace App\Logic;
use App\Model\DataDictionaryModel;
use Core\PubFunc;
class DataDictionaryLogic
{
    private $dataDictionaryModel;
    function __construct()
    {
        $this->dataDictionaryModel = new DataDictionaryModel();
    }

    function getAllDataDictionary($fields = '*')
    {
        $rs = $this->dataDictionaryModel->selectAll('','WHERE is_del=1',null,$fields);
        unset($this->dataDictionaryModel);
        return $rs;
    }

    function getAll($sql='',$where='WHERE is_del=1',$param=null,$fields = '*')
    {
        $rs = $this->dataDictionaryModel->selectAll($sql,$where,$param,$fields);
        unset($this->dataDictionaryModel);
        return $rs;
    }
    /**
    ...
    {
        $rs = $this->dataDictionaryModel->sql($sql,$param);
        unset($this->dataDictionaryModel);
        return $rs;
    }
    ...
    {
        $fields = $this->dataDictionaryModel->fields;
        $tmpArray = array();
    ...
    function pageDataDictionaryList( $param)
    {
        $p = 1;
        if (!empty($param['p'])) {
            $p = $param['p'];
        ...
        unset($param['p']);
        $where = ' WHERE 1=1 ';
        $changeResult = $this->dataDictionaryModel->getWhereAndParamForPage($param);
        ...
        $rs = $this->dataDictionaryModel->page($p, 0, '', $where,$data , $field = '*');
        return $rs;
    }
    ...
    {
        $rs = $this->dataDictionaryModel->insert($data);
        return $rs;
    }
    ...
    {
        $rs = $this->dataDictionaryModel->_testData;
        $rs['is_del']=1;
        return $rs;
    }
    ...
    {
        $rs = $this->dataDictionaryModel->updateAuto($data);
        return $rs;
    }
    ...
    function getById( $id,$fields = '*')
    {
        ...
        $rs = $this->dataDictionaryModel->selectOne('','WHERE id=:id',array('id'=>$id),$fields);
        return $rs;
    }
    ...
    {
        $rs = $this->dataDictionaryModel->selectOne($sql,$where,$param,$fields);
        return $rs;
    }
    ...
    {
        $rs = $this->dataDictionaryModel->selectAll('','WHERE is_del=1 AND datadictionarytype_id=:ddtid',array('ddtid'=>$typeID),'id,value_desc');
        return $rs;
    }
