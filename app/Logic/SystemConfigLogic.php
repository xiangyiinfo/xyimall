...
class SystemConfigLogic
{
    ...
    function getAllSystemConfig($fields = '*')
    {
        $rs = $this->systemConfigModel->selectAll('','WHERE is_del=1',null,$fields);
        unset($this->systemConfigModel);
        return $rs;
    }
    
    function getAll($sql='',$where='WHERE is_del=1',$param=null,$fields = '*')
    {
        $rs = $this->systemConfigModel->selectAll($sql,$where,$param,$fields);
        unset($this->systemConfigModel);
        return $rs;
    }
    /**
    ...
    {
        $rs = $this->systemConfigModel->sql($sql,$param);
        unset($this->systemConfigModel);
        return $rs;
    }
    ...
    {
        $fields = $this->systemConfigModel->fields;
        $tmpArray = array();
    ...
    function pageSystemConfigList( $param)
    {
        $p = 1;
        if (!empty($param['p'])) {
            $p = $param['p'];
        ...
        unset($param['p']);
        $where = ' WHERE 1=1 ';
        $changeResult = $this->systemConfigModel->getWhereAndParamForPage($param);
        ...
        $rs = $this->systemConfigModel->page($p, 0, '', $where,$data , $field = '*');
        return $rs;
    }
    ...
    {
        $rs = $this->systemConfigModel->insert($data);
        return $rs;
    }
    ...
    {
        $rs = $this->systemConfigModel->_testData;
        $rs['is_del']=1;
        return $rs;
    }
    ...
    {
        $rs = $this->systemConfigModel->updateAuto($data);
        return $rs;
    }
    ...
    function getById( $id,$fields = '*')
    {
        ...
        $rs = $this->systemConfigModel->selectOne('','WHERE id=:id',array('id'=>$id),$fields);
        return $rs;
    }
    ...
    {
        $rs = $this->systemConfigModel->selectOne($sql,$where,$param,$fields);
        return $rs;
    }
}