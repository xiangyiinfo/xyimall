                            ...
                            <div class="card-content">
                                <div class="row hh-add-edit">
                                    <dl class="col s12 m6">
                                        <dt><b>商品属性名称</b></dt>
                                        <dd>
                                            <div class="col s10 m8"><input placeholder="商品属性名称" id="goodsattr_name" name="goodsattr_name" value="<?php echo $tableObject['goodsattr_name'];?>" class="validate[required,minSize[2],maxSize[20]]" type="text"></div>
                                        </dd>
                                    </dl>
                                    <dl class="col s12 m6">
                                        <dt><b>商品属性值</b></dt>
                                        <dd>
                                            <div class="col s12 m8"><input placeholder="多个值以'|'隔开" id="goodsattr_value" name="goodsattr_value" value="<?php echo $tableObject['goodsattr_value'];?>" class="validate[required,minSize[2],maxSize[200]]" type="text"></div>
                                        </dd>
                                    </dl>
                                    <dl class="col s12">
                                        <dt><b>选择商品类别</b></dt>
                                        <dd>
                                            ...
                                            <input type="hidden" name="id" id="id" value="<?php echo $tableObject['id'];?>" />
                                            <input type="hidden" name="category_id" id="category_id" value="<?php echo $goodscate_name['id'];?>" />
                                        </dd>
                                    </dl>
                                    <dl class="col s12 m6">
                                        <dt><b>排序</b></dt>
                                        <dd>
                                            <div class="col s12 m8"><input id="goodsattr_sort" name="goodsattr_sort" value="<?php echo $tableObject['goodsattr_sort'];?>" placeholder="越大的数字排得越前" class="validate[required,custom[number],min[0],max[9999999999]]" type="text"></div>
                                        </dd>
                                    </dl>
...
<script type="text/javascript">
    ...
    $(function () {
        $('#commoditydd').html("<?php echo $goodscate_name['goodscate_name'];?>");
        ...
        function submitAdd()
        {
            if ($('#category_id').val() == '')
            {
                ...
                if ($('#validate_form').validationEngine('validate')) {
                    ...
                    $.ajax({
                        url: "<?php echo HTTP_DOMAIN."/admin_doeditgoodsatt";?>" ,
                        dataType: 'json',
                        type: 'post',
                        data:param,
