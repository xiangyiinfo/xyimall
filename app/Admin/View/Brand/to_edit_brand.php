                                ...
                                <div class="row hh-add-edit">
                                    ...
                                    <dl class="col s12">
                                        ...
                                        <dd>
                                            ...
                                            <input type="hidden" name="c_name" id="c_name" value="<?php echo $catename?>" />
                                            <input type="hidden" name="c_id" id="c_id" value="<?php echo $cateid?>" />
                                    ...
                                    <dl class="col s12 m6">
                                        ...
                                        <div class="col s4">
                                            <div class="dz-wrapper clearfix">
                                                <img src="<?php echo HTTP_DOMAIN.'/images/uploads_thumb/'.$tableObject['brand_logo'];?>" id="mainthumb"   name="mainthumb" style="width: 200px; height:200px">
                                            </div>
                                        </div>
                                    </dl>
...
<script type="text/javascript">
        ...
        function submitAdd()
        {
            if ($('#category_id').val() == '')
            {
                ...
                if ($('#validate_form').validationEngine('validate')) {
                    ...
                    $.ajax({
                        url: "<?php echo HTTP_DOMAIN."/admin_doeditbrand";?>" ,
                        dataType: 'json',
                        type: 'post',
                        data:param,
    ...
    $('#myDropzone').dropzone({
        ...
        sending: function(file, xhr, formData) {
            formData.append("bid", <?php echo $option['bid'];?>);
        },
        ...
        removedfile: function(a) {
            ...
            $.ajax({
                ...
                dataType:"json",
                data:{'bid':<?php echo $option['bid'];?>,'agid':a.previewElement.id},
                type:'POST',
                success:function (data) {
                    swal(data);
                }
